...
const Contact = () => {
  return (
    <div className="max-w-screen-xl mx-40 mt-24 sm:px-6">
      ...
      <p className="text-[16px] text-[#9F9F9F] font-normal text-center mt-[30px] sm:w-full sm:text-sm">
        For More Information About Our Product & Services. Please Feel Free To Drop Us</p>
        <p className="text-[16px] text-[#9F9F9F] font-normal text-center mt-[10px] sm:w-full sm:text-sm">
        An Email. Our Staff Always Be There To Help You Out. Do Not
        Hesitate!
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 mt-[60px]">
        <div className="flex flex-col space-y-8 px-6 sm:px-10">
          <div className="flex items-start space-x-4 mt-10">
            ...
            <div>
              ...
              <p className="text-black font-normal text-[14px] sm:text-[16px]">
                236 5th SE Avenue, New</p>
                <p>York NY10000, United States
              </p>
            </div>
          </div>

          <div className="flex items-start space-x-4">
            <FaPhone className="text-black h-[27.59px] mt-8" />
            <div>
              <h2
                className={`${poppins.className} text-[20px] sm:text-[24px] mt-8 font-medium`}
              >
                Phone
              </h2>
              <p className="text-black font-normal text-[14px] sm:text-[16px]">
          ...
          <div className="flex items-start space-x-4">
            <GoClockFill className="text-black h-[27.59px] mt-8" />
            <div>
              <h2
                className={`${poppins.className} text-[20px] sm:text-[24px] mt-8 font-medium`}
              >
